...
In the near future, most digital products won't need to be built by programmers. This is a clear trend, and we want to radically accelerate it. 

We're building tools that will enable other employees and domain experts to build most applications and digitize processes themselves, in a way that doesn't just avoid adding to their workload, but actually makes their jobs easier.
...
### Our products help organizations self-host and use AI:

- [Paddler](https://paddler.intentee.com/)- Host and serve open-source LLMs on your own infrastructure at scale
- [Poet](https://poet.intentee.com/) (alpha version)- Transform static documentation into interactive, AI-searchable content
...
<TeamMember 
    src="resources/media/team/mateusz-charytoniuk.avif"
    title="Mateusz Charytoniuk, co&#8209;founder, technology"
>
    ...
    - [github](https://linkedin.com/in/mateusz-charytoniuk)
    - [linkedin](https://linkedin.com/in/mateusz-charytoniuk)
    - [mail](mailto:mateusz@intentee.com)
</TeamMember>

<TeamMember 
    src="resources/media/team/malgorzata-zagajewska.avif"
    title="Małgorzata Zagajewska, co&#8209;founder, product"
>
